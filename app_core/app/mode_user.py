...
from app_core.rule_core.encounter import start_user_encounter
from app_core.rule_core.triage_policy import TriageInput
from app_core.app.schema import PayloadError, error_response, validate_encounter_start_payload
