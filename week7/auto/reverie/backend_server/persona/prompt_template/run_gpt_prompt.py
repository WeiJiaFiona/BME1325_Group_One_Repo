...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False): 
  ...
  prompt_template = "persona/prompt_template/ED/v2/wake_up_hour_v1.txt"
...
def run_gpt_prompt_daily_plan(persona, 
  ...
  def get_fail_safe(): 
    ...
    #       'write daily report at 7:00 am', 
    #       'check on patients from 8:00 am to 12:00 pm', 
    #       'have lunch at 12:00 pm', 
    #       'check on patients from 1:00 pm to 4:00 pm', 
    #       'write daily report from 7:00 pm to 8:00 pm', 
    #       'go to bed at 11:00 pm'] 
    fs = ['wake up and start shift at 6:00 am',
          'document patient updates at 7:00 am',
          'assess and treat patients from 8:00 am to 12:00 pm',
          'take a lunch break at 12:00 pm',
          'continue assessing and treating patients from 1:00 pm to 4:00 pm',
          'document end-of-shift notes from 7:00 pm to 8:00 pm',
          'end shift and rest at 11:00 pm']
    return fs
  ...
  prompt_template = f"persona/prompt_template/ED/v2/{persona.role}/daily_planning_v6.txt"
  ...
  output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
                                   __func_validate, __func_clean_up)
  output = ([f"At the emergency department at {wake_up_hour}:00 am"]
              + output)
...
def run_gpt_prompt_generate_hourly_schedule(persona, 
  ...
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v3_ChatGPT/generate_hourly_schedule_v2.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 50, 
               ...
               "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  prompt_template = f"persona/prompt_template/ED/v2/{persona.role}/generate_hourly_schedule_v2.txt"
  prompt_input = create_prompt_input(persona, 
                                     curr_hour_str, 
                                     p_f_ds_hourly_org,
                                     hour_str, 
...
def run_gpt_prompt_task_decomp(persona, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 1000, 
             "temperature": 0, "top_p": 1, "stream": False,
             "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/task_decomp_v3.txt"
...
def run_gpt_prompt_action_sector(action_description, 
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v3_ChatGPT/action_location_sector_v2.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v1/{persona.role}/action_location_sector_v1.txt"
  prompt_input = create_prompt_input(action_description, persona, maze)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_action_arena(action_description, 
  ...
  def create_prompt_input(action_description, persona, maze, act_world, act_sector, test_input=None): 
    ...
    prompt_input += [persona.scratch.get_str_name()] # input 1 action_location_object_vMar11.txt
    x = f"{act_world}:{act_sector}"
    prompt_input += [act_sector]  # input 2 action_location_object_vMar11.txt
    ...
    prompt_input += [accessible_arena_str] # input 3 action_location_object_vMar11.txt
    ...
    if "(" in action_description: 
      action_description_1 = action_description.split("(")[0].strip()
      action_description_2 = action_description.split("(")[-1][:-1]
    prompt_input += [persona.scratch.get_str_name()] # input 4 action_location_object_vMar11.txt
    prompt_input += [action_description_1] # input 5 action_location_object_vMar11.txt

    prompt_input += [action_description_2] # input 6 action_location_object_vMar11.txt
    prompt_input += [persona.scratch.get_str_name()] # input 7 action_location_object_vMar11.txt

    

    prompt_input += [act_sector] # input 8 action_location_object_vMar11.txt
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v1/{persona.role}/action_location_object_vMar11.txt"
...
def run_gpt_prompt_action_game_object(action_description, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v1/{persona.role}/action_object_v2.txt"
  ...
  if debug or verbose: 
    print_run_prompts(prompt_template, persona, gpt_param, 
                      prompt_input, prompt, output)
  # Because sometimes the LLM outputs traige even though there is no mention of traige in the prompt
  output = output.replace("traige", "triage")
  return output, [output, prompt, gpt_param, prompt_input, fail_safe]
...
def run_gpt_prompt_pronunciatio(action_description, persona, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/generate_pronunciatio_v1.txt" ########
  prompt_input = create_prompt_input(action_description)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  example_output = "🛁🧖‍♀️" ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  # prompt_template = "persona/prompt_template/ED/v2/generate_pronunciatio_v1.txt"
  # prompt_input = create_prompt_input(action_description)
...
def run_gpt_prompt_event_triple(action_description, persona, verbose=False): 
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v3_ChatGPT/generate_event_triple_v1.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 30, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  prompt_template = "persona/prompt_template/ED/v2/generate_event_triple_v1.txt"
  prompt_input = create_prompt_input(action_description, persona)
  prompt = generate_prompt(prompt_input, prompt_template)
  fail_safe = get_fail_safe(persona) ########
  output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
...
def run_gpt_prompt_act_obj_desc(act_game_object, act_desp, persona, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/generate_obj_event_v1.txt" ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  # prompt_template = "persona/prompt_template/ED/v2/generate_obj_event_v1.txt"
  # prompt_input = create_prompt_input(act_game_object, act_desp, persona)
  # prompt = generate_prompt(prompt_input, prompt_template)
  # fail_safe = get_fail_safe(act_game_object)
  # output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
...
def run_gpt_prompt_new_decomp_schedule(persona, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 1000, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/new_decomp_schedule_v1.txt"
  prompt_input = create_prompt_input(persona, 
                                     main_act_dur, 
                                     truncated_act_dur, 
                                     start_time_hour,
...
def run_gpt_prompt_decide_to_talk(persona, target_persona, retrieved,test_input=None, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 20, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v2/{persona.role}/decide_to_talk_v2.txt"
...
def run_gpt_prompt_decide_to_react(persona, target_persona, retrieved,test_input=None, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 20, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v2/{persona.role}/decide_to_react_v1.txt"
  prompt_input = create_prompt_input(persona, target_persona, retrieved,
                                     test_input)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_create_conversation(persona, target_persona, curr_loc,
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 1000, 
               ...
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v2/{persona.role}/create_conversation_v2.txt"
...
def run_gpt_prompt_summarize_conversation(persona, conversation, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v3_ChatGPT/{persona.role}/summarize_conversation_v1.txt" ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v2/summarize_conversation_v1.txt"
  # prompt_input = create_prompt_input(conversation, test_input)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_extract_keywords(persona, description, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 50, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v2/{persona.role}/get_keywords_v1.txt"
...
def run_gpt_prompt_keyword_to_thoughts(persona, keyword, concept_summary, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 40, 
               "temperature": 0.7, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/keyword_to_thoughts_v1.txt"
...
def run_gpt_prompt_convo_to_thoughts(persona, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 40, 
               "temperature": 0.7, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/convo_to_thoughts_v1.txt"
...
def run_gpt_prompt_event_poignancy(persona, event_description, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/poignancy_event_v1.txt" ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v2/poignancy_event_v1.txt"
  # prompt_input = create_prompt_input(persona, event_description)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_thought_poignancy(persona, event_description, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/poignancy_thought_v1.txt" ########
  prompt_input = create_prompt_input(persona, event_description)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  example_output = "5" ########
  special_instruction = "The output should ONLY contain ONE integer value on the scale of 1 to 10." ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v2/poignancy_thought_v1.txt"
  # prompt_input = create_prompt_input(persona, event_description)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_chat_poignancy(persona, event_description, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v3_ChatGPT/{persona.role}/poignancy_chat_v1.txt" ########
  prompt_input = create_prompt_input(persona, event_description)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  example_output = "5" ########
  special_instruction = "The output should ONLY contain ONE integer value on the scale of 1 to 10." ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v2/poignancy_chat_v1.txt"
  # prompt_input = create_prompt_input(persona, event_description)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_focal_pt(persona, statements, n, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/generate_focal_pt_v1.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 150, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/generate_focal_pt_v1.txt"
  prompt_input = create_prompt_input(persona, statements, n)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_insight_and_guidance(persona, statements, n, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 150, 
               "temperature": 0.5, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/insight_and_evidence_v1.txt"
  prompt_input = create_prompt_input(persona, statements, n)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_agent_chat_summarize_ideas(persona, target_persona, statements, curr_context, test_input=None, verbose=False): 
  def create_prompt_input(persona, target_persona, statements, curr_context, test_input=None): 
    prompt_input = [persona.scratch.get_str_curr_date_str(), curr_context, persona.scratch.current_state, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v3_ChatGPT/{persona.role}/summarize_chat_ideas_v1.txt" ########
  ...
  #              "temperature": 0.5, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v2/summarize_chat_ideas_v1.txt"
  # prompt_input = create_prompt_input(persona, target_persona, statements, curr_context)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_agent_chat_summarize_relationship(persona, target_persona, statements, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/summarize_chat_relationship_v2.txt" ########
  ...
  #              "temperature": 0.5, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v2/summarize_chat_relationship_v1.txt"
  # prompt_input = create_prompt_input(persona, target_persona, statements)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_agent_chat(maze, persona, target_persona,
  ...
  def create_prompt_input(persona, target_persona, curr_context, init_summ_idea, target_summ_idea, test_input=None): 
    ...
    prompt_input = [persona.scratch.current_state, 
                    target_persona.scratch.current_state, 
                    prev_convo_insert,
                    curr_context, 
                    curr_location,
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/agent_chat_v1.txt" ########
  ...
  #              "temperature": 0.7, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v2/agent_chat_v1.txt"
  # prompt_input = create_prompt_input(persona, target_persona, curr_context, init_summ_idea, target_summ_idea)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_summarize_ideas(persona, statements, question, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/summarize_ideas_v1.txt" ########
  ...
  #              "temperature": 0.5, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v2/summarize_ideas_v1.txt"
  # prompt_input = create_prompt_input(persona, statements, question)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_generate_next_convo_line(persona, interlocutor_desc, prev_convo, retrieved_summary, test_input=None, verbose=False): 
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = "persona/prompt_template/ED/v3_ChatGPT/generate_next_convo_line_v1.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 250, 
               "temperature": 1, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/generate_next_convo_line_v1.txt"
  prompt_input = create_prompt_input(persona, interlocutor_desc, prev_convo, retrieved_summary)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_generate_whisper_inner_thought(persona, whisper, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 50, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/whisper_inner_thought_v1.txt"
...
def run_gpt_prompt_planning_thought_on_convo(persona, all_utt, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 50, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = f"persona/prompt_template/ED/v2/{persona.role}/planning_thought_on_convo_v1.txt"
...
def run_gpt_prompt_memo_on_convo(persona, all_utt, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v3_ChatGPT/memo_on_convo_v1.txt" ########
  prompt_input = create_prompt_input(persona, all_utt)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  ...
  gpt_param = {"engine": "gpt-3.5-turbo", "max_tokens": 50, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = "persona/prompt_template/ED/v2/memo_on_convo_v1.txt"
  prompt_input = create_prompt_input(persona, all_utt)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_generate_safety_score(persona, comment, test_input=None, verbose=False): 
  ...
  print ("11")
  prompt_template = "persona/prompt_template/ED/safety/anthromorphosization_v1.txt" 
...
def run_gpt_generate_iterative_chat_utt(maze, init_persona, target_persona, retrieved, curr_context, curr_chat, test_input=None, verbose=False): 
  ...
  print ("11")
  prompt_template = f"persona/prompt_template/ED/v3_ChatGPT/{init_persona.role}/iterative_convo_v1.txt" 
...
def run_gpt_generate_patient_scratch(role,patient_description, verbose = False):
  def __chat_func_clean_up(gpt_response, prompt=""): 
    json_reponse = json.loads(gpt_response)
  ...
  def create_prompt_input(patient_desc): 
    prompt_input = [patient_desc]
    return prompt_input
  
  def __extract_name():
    name_match = re.search(r"Name:\s*\(([^)]+)\)", patient_description or "")
    if name_match:
      return name_match.group(1).strip()
    return f"{role} {get_random_alphanumeric(3, 4)}"

  def __extract_patient_description():
    desc_match = re.search(r"Description:\s*(.*?)(?:\s*\|\s*Innate:|\s*$)", patient_description or "")
    if not desc_match:
      return "feeling unwell and waiting for treatment"
    return desc_match.group(1).strip()

  def __extract_innate():
    innate_match = re.search(r"Innate:\s*(.*)$", patient_description or "")
    if not innate_match:
      return "cooperative"
    return innate_match.group(1).strip()

  def __offline_fallback():
    """
    Build a deterministic scratch when GPT is unavailable (e.g., offline or missing API key).
    This avoids blocking simulation startup for staff roles like BedsideNurse.
    """
    extracted_name = __extract_name()
    first = extracted_name.split()[0] if extracted_name else role
    last = " ".join(extracted_name.split()[1:]) if len(extracted_name.split()) > 1 else extracted_name
    pain_score = (sum(ord(ch) for ch in extracted_name) % 10) + 1

    if role.lower() == "patient":
      description = __extract_patient_description()
      innate = __extract_innate()
      return {
        "vision_r": 4,
        "att_bandwidth": 16,
        "retention": 8,
        "curr_time": None,
        "curr_tile": None,
        "schedule_constraints": "Patient should remain in the emergency department until discharged or admitted.",
        "name": extracted_name,
        "first_name": first,
        "last_name": last,
        "age": 30,
        "behavior_modifiers": innate,
        "role_description": f"{extracted_name} is a hospital patient in the emergency department. Not part of the emergency department staff. They should wait for instructions from medical staff and move only when directed.",
        "current_state": f"{extracted_name} just arrived at emergency department. Patient is experiencing {description}. Pain on scale is {pain_score}. Now waiting for treatment.",
        "work_pattern": f"{extracted_name} stays at the emergency department until treatment is complete.",
        "living_area": "ed map:emergency department:waiting room",
        "concept_forget": 100,
        ...
        "act_event": [extracted_name, None, None],
    ...
    return {
      ...
      "curr_time": None,
      "curr_tile": None,
      "schedule_constraints": f"{role} works in the emergency department every day, working 24/7",
      "name": extracted_name,
      "first_name": first,
      "last_name": last,
      "age": 30,
      "behavior_modifiers": "friendly, outgoing, hospitable",
      "role_description": f"{role} is a hospital employee in the emergency department, caring for patients in major and minor injuries zones.",
      "current_state": f"{role} wants to help patients and works with doctors and triage nurses.",
      "work_pattern": f"{role} works 24/7 at the emergency department",
  ...
  if llm_local_only_mode():
    return __offline_fallback()

  prompt_template = f"persona/prompt_template/ED/v3_ChatGPT/{role}/generate_new_scratch.txt"
  prompt_input = create_prompt_input(patient_description)
  prompt = generate_prompt(prompt_input, prompt_template)

  output = None
  try:
    output = ChatGPT_safe_generate_response_OLD(prompt=prompt, func_validate=__chat_func_validate, func_clean_up=__chat_func_clean_up)
  except Exception:
    output = None

  # Fallback for offline / invalid responses
  if not isinstance(output, dict):
    output = __offline_fallback()

  return output


def run_gpt_generate_next_patient(persona, personas, queue):
  def __chat_func_clean_up(gpt_response, prompt=""): 
    """
    The model sometimes wraps the patient name in quotes (e.g., 20, 'Patient 41')
    which later confuses queue removal and plan execution. Normalize the output
    so we always return [priority:int, patient_name:str] with a bare name.
    """
    if not gpt_response:
      raise ValueError("Empty response from next patient prompt")

    parts = [p.strip() for p in gpt_response.split(",")]
    if len(parts) < 2:
      raise ValueError(f"Unexpected next patient format: {gpt_response}")
    priority = int(float(parts[0].strip("\"'`")))

    name = parts[1] if len(parts) > 1 else ""
    # Remove stray surrounding quotes/backticks without touching inner apostrophes.
  ...
  def create_prompt_input(queue, patients_info, doctor_perf): 
    prompt_input = [queue, patients_info, doctor_perf]
    return prompt_input
  
  if llm_local_only_mode():
    for entry in queue:
      if len(entry) >= 2:
        fallback_name = str(entry[1]).strip()
        if fallback_name in personas:
          return [int(entry[0]), fallback_name]
    raise RuntimeError("next_patient: no viable queue fallback in local_only mode.")

  prompt_template = f"persona/prompt_template/ED/v3_ChatGPT/{persona.role}/next_patient.txt"

  patients_info = []

  for patient in queue:
    p = personas.get(patient[1])
    if p:
      patients_info.append([patient[1], p.scratch.current_state])

  prompt_input = create_prompt_input(queue, patients_info, persona.scratch.role_description)
  prompt = generate_prompt(prompt_input, prompt_template)

  output = ChatGPT_safe_generate_response_OLD(prompt, func_validate=__chat_func_validate, func_clean_up=__chat_func_clean_up)
  # return output
  if isinstance(output, (list, tuple)) and len(output) >= 2:
      try:
          priority = int(float(output[0]))
      except (TypeError, ValueError):
          priority = None
      name = str(output[1]).strip().strip("\"'`")
      if priority is not None and name in personas:
          return [priority, name]

  # Fallback when GPT failed or returned an unknown patient
  for entry in queue:
      if len(entry) >= 2:
          fallback_name = str(entry[1]).strip()
          if fallback_name in personas:
  ...
  raise RuntimeError(f"next_patient: invalid response {output!r} and no viable queue fallback.")



def run_gpt_generate_should_patient_leave(persona, time):
  def create_prompt_input(condition, behaviour, state, time): 
    prompt_input = [condition, behaviour, state, time]
    return prompt_input
    
  prompt_template = f"persona/prompt_template/ED/v1/{persona.role}/decide_to_leave.txt"


  prompt_input = create_prompt_input(persona.scratch.current_state, persona.scratch.behavior_modifiers, persona.scratch.state, time)
  prompt = generate_prompt(prompt_input, prompt_template)
