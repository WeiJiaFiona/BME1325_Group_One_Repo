# Week 8 Codex Implementation Spec — Memory v1 on Merged ED-MAS and you are Developer A, you need to pay more attention to the Developer A part but also accomadate to Developer B plan and the whole system to run smoothly
...
* The public repo exists, and the currently visible branch in the web UI is `week3_0320`. ([GitHub](https://github.com/XanderZhou2022/BME_1325_Group4_repo "GitHub - XanderZhou2022/BME_1325_Group4_repo · GitHub"))
* Under `system/backend`, it contains:
  * `api/`
  * `测试数据库/`
  * `requirements.txt`
  * `.env`
  * `数据规范/` ([GitHub](https://github.com/XanderZhou2022/BME_1325_Group4_repo/tree/week3_0320/system/backend "BME_1325_Group4_repo/system/backend at week3_0320 · XanderZhou2022/BME_1325_Group4_repo · GitHub"))
* Inside `system/backend/api/README.md`, the repo explicitly describes:
  ...
  * DB health endpoint references. ([GitHub](https://github.com/XanderZhou2022/BME_1325_Group4_repo/tree/week3_0320/system/backend/api "BME_1325_Group4_repo/system/backend/api at week3_0320 · XanderZhou2022/BME_1325_Group4_repo · GitHub"))
